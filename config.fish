...
function fish_prompt --description 'Write out the prompt'
    ...
    # Don't modify $status until necessary
    ...
    set -l status_color (set_color $fish_color_status; or set_color red)
    set -l statusb_color (set_color --bold $fish_color_status; or set_color --bold red)

    # Only set __fish_last_status right before it's needed
